...
local default_action_map = {
  ...
  ['test-nearest'] = { act = "<cmd>lua require'goldsmith.testing'.nearest({false,{}})<cr>", ft = { 'go' } },
  ['test-suite'] = { act = "<cmd>lua require'goldsmith.testing'.suite({false,{}}})<cr>", ft = { 'go' } },
  ['test-pkg'] = { act = "<cmd>lua require'goldsmith.testing'.pkg({false,{}})<cr>", ft = { 'go' } },
  ['test-b-nearest'] = { act = "<cmd>lua require'goldsmith.testing'.nearest({true,{}})<cr>", ft = { 'go' } },
  ['test-b-suite'] = { act = "<cmd>lua require'goldsmith.testing'.suite({true,{}})<cr>", ft = { 'go' } },
  ['test-b-pkg'] = { act = "<cmd>lua require'goldsmith.testing'.pkg({true,{}})<cr>", ft = { 'go' } },
