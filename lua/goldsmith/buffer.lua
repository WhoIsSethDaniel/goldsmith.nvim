...
local default_action_map = {
  ...
  ['test-nearest'] = { act = "<cmd>lua require'goldsmith.testing'.nearest({type='test',{}})<cr>", ft = { 'go' } },
  ['test-suite'] = { act = "<cmd>lua require'goldsmith.testing'.suite({type='test',{}}})<cr>", ft = { 'go' } },
  ['test-pkg'] = { act = "<cmd>lua require'goldsmith.testing'.pkg({type='test',{}})<cr>", ft = { 'go' } },
