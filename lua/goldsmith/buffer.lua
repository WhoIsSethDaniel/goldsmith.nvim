...
local default_action_map = {
  ...
  ['test-b-nearest'] = { act = "<cmd>lua require'goldsmith.testing'.nearest()<cr>", ft = { 'go' } },
  ['test-b-suite'] = { act = "<cmd>lua require'goldsmith.testing'.suite()<cr>", ft = { 'go' } },
  ['test-b-pkg'] = { act = "<cmd>lua require'goldsmith.testing'.pkg()<cr>", ft = { 'go' } },
  ['test-a-nearest'] = { act = "<cmd>lua require'goldsmith.testing'.nearest()<cr>", ft = { 'go' } },
  ['test-a-suite'] = { act = "<cmd>lua require'goldsmith.testing'.suite()<cr>", ft = { 'go' } },
  ['test-a-pkg'] = { act = "<cmd>lua require'goldsmith.testing'.pkg()<cr>", ft = { 'go' } },
